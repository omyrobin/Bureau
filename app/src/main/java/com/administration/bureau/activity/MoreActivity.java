...
public class MoreActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void requestLawsData(){
        ...
        Observable<Response<BaseResponse<ArticleEntity>>> observable = getService.getLawsArticle("article",2, Constant.languages[0]);
        RetrofitClient.client().request(observable, new ProgressSubscriber<ArticleEntity>(this) {
            ...
            protected void onSuccess(ArticleEntity articleEntity) {
                lawsRv.setAdapter(new ArticleAdapter(MoreActivity.this, articleEntity.getData(),true));
