...
public class ServiceInfoActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void initializeToolbar() {
        titleTv.setText(R.string.service_information);
    ...
    private void requestLawsData(){
        ...
        Observable<Response<BaseResponse<ArticleEntity>>> observable = getService.getLawsArticle("article",5, Constant.languages[App.locale]);
        RetrofitClient.client().request(observable, new ProgressSubscriber<ArticleEntity>(this) {
            ...
            protected void onSuccess(ArticleEntity articleEntity) {
                lawsRv.setAdapter(new ArticleAdapter(ServiceInfoActivity.this, articleEntity.getData(),false));
